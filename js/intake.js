document.addEventListener("DOMContentLoaded", async (event) => {
  ...
  if (!data) {
    data = {"intake":[{"name":"Kein Eintrag", "value":"0"}]};
    saveIntakeData(data);
  }
...
document.getElementById('bbuddy__add-form').addEventListener('submit', function(e) {
    e.preventDefault();
    addIntakeToSession();
});
